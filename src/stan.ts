...
const stanSimpleMode = simpleMode({
  ...
  start: [
    ...
    // stan functions
    {
      // deprecated
      regex:
        /\b([A-Za-z0-9][A-Za-z0-9_]*_log|binomial_coefficient_log|fabs|get_lp|if_else|increment_log_prob|integrate_ode[A-Za-z0-9_]*|lkj_cov_lpdf|multiply_log)\b/,
      token: 'variable-2'
    },
    {
      // builtint
